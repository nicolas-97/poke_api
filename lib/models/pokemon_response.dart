...
//
//     final pokemonDetailsResponse = pokemonDetailsResponseFromJson(jsonString);

import 'dart:convert';

PokemonDetailsResponse pokemonDetailsResponseFromJson(String str) => PokemonDetailsResponse.fromJson(json.decode(str));

String pokemonDetailsResponseToJson(PokemonDetailsResponse data) => json.encode(data.toJson());
